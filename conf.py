...
BLOG_AUTHOR = "Petar Mlinarić"  # (translatable)
BLOG_TITLE = "Petar Mlinarić"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://pmli.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://petarmlinaric.from.hr/"
BLOG_EMAIL = "mlinaric@vt.edu"
BLOG_DESCRIPTION = "Personal website of Petar Mlinarić"  # (translatable)
