...
abstract: >-
  Interpolatory necessary optimality conditions for $\mathcal{H}_2$-optimal
  ...
  different structured settings, bitangential Hermite interpolation is the
  common form for optimality, thus proving a unifying optimality framework for
